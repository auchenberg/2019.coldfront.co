    ...
    <Layout>
        ...
        <Section>
            <Intro
                ...
                text="ColdFront 2018 will play out at the magnificent VEGA, one of the leading concert stages in Europe, located in Vesterbro, the sweet spot of central Copenhagen, in walking distrance to the hip Meet Packing District."/>

                <div className="narrow">
                    <p><a href="http://vega.dk">VEGA</a> is showcasing the original 50's design giving the building a unique atmosphere, and VEGA's decor with dark wood paneling, mahogany floors, friezes, and the many original details including railings, balustrades and lamps in typical Scandinavian style are the hallmarks of VEGA.</p>
