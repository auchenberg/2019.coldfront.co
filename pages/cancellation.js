  ...
  <Layout title="Cancellation of ColdFront 2019">
    ...
    <Section bright>
      <div className="narrow">
        <p>Following weeks of deliberate conversations, we have made the decision to cancel ColdFront 2019 which was scheduled to take place on 26-29th November 2019 in Copenhagen.</p>

        <p>We have reached this conclusion as we won’t be able to deliver a ColdFront in the same quality as our previous years, due to unavoidable circumstances for the organizing team.</p>

        <p>We know that many of you have been looking forward to ColdFront 2019, and so have we. We are sorry for this cancellation, but we’d rather cancel ColdFront than selling tickets to an event that does not meet the bar.</p>
        ...
        <p>So this means that ColdFront will take a break here in 2019, and we’ll use this break to re-think what’s next for ColdFront, and how we can rethink the setup and organizing team around the conference.</p>
