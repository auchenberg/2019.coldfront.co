...
export default () => (
    <Layout>
        ...
        <WideSection>
            ...
            <p className="font-bitblox">Shirley Wu</p>
            <p className="font-bitblox">Freelance Software Engineer</p>
            ...
            <p>
            Shirley Wu is a freelance software engineer specializing in data visualization. She combines her love of art, math, and code into colorful, interactive data visualizations. She enjoys finding fun insights in data and weaving them into stories and exploratory tools for the reader to discover. Her work can be found at <a href="http://sxywu.com/">www.sxywu.com</a>.
            </p>         
        ...
        <style jsx>{`
            ...
            .speaker-avatar {
                background-image: url(/static/images/speakers/speaker-shirley.jpg);
